...
Za dotično poduzeće mora biti aktiviran flag (u tablici Preduzeće - SH_Companies izravno u bazi podataka) koji omogućuje kreiranje ulaznih računa iz SDI datoteke.
