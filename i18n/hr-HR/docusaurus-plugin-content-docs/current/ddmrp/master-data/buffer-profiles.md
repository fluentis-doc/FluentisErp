---
title: Profili buffera 
sidebar_position: 4
---

Profil *buffera* definira zajedničke karakteristike za mnoge artikle sa *bufferom*.    
Na taj način, svaki artikl sa bufferom može imati svoj profil, što olakšava i ubrzava izmjenu njegovih parametara. Naime, svaka izmjena u profilu automatski će se primijeniti na sve artikle povezane s tim profilom.   
...
3. **kategorija varijabilnosti**
   ...
   Što je varijabilnost veća, to mora biti viša razina sigurnosnih zaliha buffera (crvena zona), što je zapravo proporcionalno koeficijentu varijabilnosti.   
