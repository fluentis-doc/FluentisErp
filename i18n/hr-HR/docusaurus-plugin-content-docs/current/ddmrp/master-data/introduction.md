...
Prvo, potrebno je obavijestiti Fluentis da je artikl DDMRP buffer putem kartice [**Parametri MRP**](/docs/configurations/parameters/production/mrp-parameters/search-mrp-parameters) selekcijom vrijednosti za Politiku opskrbe među dostupnim opcijama (bufferi dinamički, bufferi fiksni, bufferi min-max).
