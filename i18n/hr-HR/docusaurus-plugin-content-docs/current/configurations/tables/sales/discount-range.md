...
La tabella si apre tramite il percorso **Tabelle > Vendite > Range sconto** e consente di definire l'elemento sul quale definire la variabilità degli scaglioni di applicazione degli sconti, sui quali definire le provvigioni agenti. Non sono flag alternativi quindi è possibile indicare più di un'opzione.
