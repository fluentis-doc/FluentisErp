...
**Tipo/Descrizione:** campi in cui viene indicato il codice e la descrizione della tipologia del documento. Importante: il codice che si inserisce deve essere univoco;
