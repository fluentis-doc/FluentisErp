...
**Pipeline Flux**: in questo campo è possibile indicare una *Pipeline flux* che dovrà essere proposta automaticamente  all’inserimento del ticket;

**Descrizione**: è la descrizione della pipeline flux indicata in precedenza.

Per ogni tipologia è possibile indicare uno o più **Stato Ticket** premendo sul pulsante ![](/img/neutral/common/new.png) Nuovo Dettaglio.

![](/img/it-it/configurations/tables/crm/ticket-state.png)
