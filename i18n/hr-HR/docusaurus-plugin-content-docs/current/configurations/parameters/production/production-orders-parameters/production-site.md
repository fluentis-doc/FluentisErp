...
Da biste umetnuli novu proizvodnu lokaciju, koristite gumb **Nuovo** u obrascu za pretraživanje.

U obrascu za unos proizvodno mjesto definirano je u gornjem dijelu pomoću polja **Šifra** i **Opis**. 

### Promjena mjesta proizvodnje

Za izmjenu proizvodnih mjesta odaberite mjesto u obrascu za pretraživanje i dvaput kliknite na red ili upotrijebite gumb **Uredi**.
