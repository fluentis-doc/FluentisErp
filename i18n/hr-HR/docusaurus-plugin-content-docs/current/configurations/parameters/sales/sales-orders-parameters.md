...
- in [Anagrafica articolo](/docs/erp-home/registers/items/create-new-item), tab Generalità, deve essere settato il flag "In esaurimento" e inoltre la "Data esaurimento" deve essere minore o uguale alla data dell'ordine.
