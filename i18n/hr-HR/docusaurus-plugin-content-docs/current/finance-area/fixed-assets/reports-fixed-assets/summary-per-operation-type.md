...
- pregled kategorije osnovnog sredstva koji omogućuje, nakon aktiviranja opcije **Kategorija osnovnog sredstva** odabir željene kategorije (ili kategorija pritiskom na tipku Ctrl). Ako zastavica nije aktivna, podaci će biti prikazani za sve kategorije;  

- donji prikaz omogućuje odabir željene vrste operacija (ili tipova pritiskom na tipku Ctrl). Uz aktivnu opciju **Sve operacije** sve će se vrste uzeti u obzir.  
