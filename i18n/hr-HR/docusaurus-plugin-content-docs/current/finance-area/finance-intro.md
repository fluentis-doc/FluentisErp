...
- [**Otvori inicijalne salda**](/docs/finance-area/ledger-records/records/procedures/automatic-accounts-opening/new) bilanca (pomoćni alat kao alternativa ručnom unosu putem računovodstvene knjiženja) ili [uvoz](/docs/applications/bizlink/import-posting-ledgers) iz drugog sustava ili automatsko ponovno otvaranje [završetka prethodne godine](/docs/finance-area/ledger-records/records/procedures/automatic-account-closing/new-account-closing)
- [Uvoz otvorenih računa ](/docs/applications/bizlink/import-open-matutities), potreban samo u slučaju migracije iz prethodnog sustava.  
- [Uvoz osnovnog sredstva](/docs/applications/bizlink/import-fixed-assets), potreban samo u slučaju migracije iz prethodnog sustava. Nabavke tijekom godine automatski dodaju informacije o imovini putem pripadajućih računovodstvenih isprava (koristeći odgovarajuće računovodstvene predloške).
- **Računovodstvene evidencije** (automatski postupak) za ciklus [**imovine**](/docs/sales/sales-invoices/accounting/sales-invoices-accounting) i **obveza** (uključujući [elektroničke fakture](/docs/finance-area/sdi-documents/incoming-purchase-documents#contabilizzazione-automatica) primljene)
