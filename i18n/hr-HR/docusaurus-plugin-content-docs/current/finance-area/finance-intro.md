...
- [**Otvori inicijalne salda**](/docs/finance-area/ledger-records/records/automatic-accounts-opening/new) bilanca (pomoćni alat kao alternativa ručnom unosu putem računovodstvene knjiženja) ili [uvoz](/docs/applications/bizlink/import-posting-ledgers) iz drugog sustava ili automatsko ponovno otvaranje [završetka prethodne godine](/docs/finance-area/ledger-records/records/automatic-account-closing/new/new-intro)
