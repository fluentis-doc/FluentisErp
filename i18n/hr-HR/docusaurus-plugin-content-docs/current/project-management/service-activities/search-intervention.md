...
Intervencije se mogu stvarati na različite načine, konkretno:
-	ručno;
-	putem Planera;
-	pomoću postupka Stvaranje Intervencija iz Zahtjeva za intervencijom ili Planiranih Intervencija;
...
Nakon postavljanja svih željenih filtara, dovoljno je kliknuti na gumb **Traži** koji se nalazi na *Ribbon traci* kako biste vidjeli rezultate unutar tablice rezultata.
...
![](/img/neutral/common/open.png) Otvori povezani račun: Ako je intervencija fakturirana, otvara povezanu fakturu;
