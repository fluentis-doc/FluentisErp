...
Ovaj postupak omogućuje analizu stanja napretka radova (WPS). U području filtra moguće je navesti niz filtera kako bi se ciljano pretražili projekti. Nakon što su filteri uneseni, dovoljno je kliknuti na gumb **Traži** u traci s alatkama kako bi se rezultati prikazali u donjoj mreži. Za izvođenje postupka, odaberite redak u mreži i kliknite gumb **WPS/SAL Analiza Projekta** u traci s alatkama. Ovo će otvoriti prozor u kojem možete pregledati informacije o napretku radova odabranog projekta.
...
**Vrsta stanja napretka radova**: prikazuje izvršeni WPS i posebno prikazuje vrstu, broj i datum; postojat će onoliko stupaca ovog tipa koliko je izvršeno WPS-a;
