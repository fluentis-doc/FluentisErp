...
Ovim postupkom provodi se postupak uvoza datoteke računovodstvenih evidencija koju je izradio DocFinance. 

Uvoz se vrši putem Bizlink *Folder Monitor* tijeka (*stream*).

Stoga će datoteka sa snimkama za uvoz biti pohranjena u mapi koju nadzire servis koji će ih automatski uvoziti. 

U ovom trenutku sustav će kreirati relevantne računovodstvene evidencije, zatvarajući stavke koje je označio DocFinance i računovodstveno bilježeći kretanja na kontima postavljenim u sustavu (računovodstveni predlošci moraju imati isti kod između ERP-a i *DocFinancea*). 

Rezultat uvoza bit će vidljiv u donjem prikazu (dok će izvršeni uvozi biti prikazani u gornjem), a pomoću naredbi na traci izbornika moći će se poništiti uvoz i pregledati pojedinosti o pogreškama pronađenim tijekom uvoz. 
