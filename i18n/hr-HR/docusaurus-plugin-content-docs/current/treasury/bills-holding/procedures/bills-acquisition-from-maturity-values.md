...
Obrazac se nalazi u Riznica > Vrijednosnih papiri > Procedure > Preuzimanje vrijednosnih papira iz dospijeća plaćanja
...
Oznaka  **Grupiranje po kontu računa** izvršava jedno knjiženje, unutar kojeg će biti onoliko redaka koliko je dospijeća plaćanja potrebno knjižiti.
