...
La sezione di **contabilizzazione** può essere impostata di default all'interno dei parametri del modulo Portafoglio effetti. Si tratta di definire la causale di contabilità, le date di riferimento per la registrazione e gli eventuali flag di raggruppamento e di registrazione provvisoria.
