...
Postupak evidentiranja vrijednosnih papira iz računa sličan je onome koji se odnosi na [**stavke dospijeća**](/docs/treasury/bills-holding/procedures/bills-acquisition-from-maturity-values), na koji se **upućuje** radi dodatnih informacija..

Izvorni podaci neće biti otvorene stavke, već izravno **rokovi dospijeća računa iz prodajnog ciklusa**.

:::tip[Napomena]
To omogućuje da se izrada i predaja dokumenata banci (na primjer bankovnih mjenica za naplatu uz klauzulu „uz dobar ishod”) obavi unaprijed, čak i prije knjiženja izdanih računa.
...
**Povrat vrijednosnih papira**: Ovim gumbom bit će izbrisano kreiranje pojedinačnog odabranog efekta.
