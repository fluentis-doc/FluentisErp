...
:::danger PAŽNJA
Stavke unesene u popis bit će vidljive samo ako imaju aktiviranu oznaku **Knjiženo** unutar njih (jer je izvršeno računovodstveno knjiženje). Budući da ih je ipak moguće unijeti u popis za prezentaciju banci, čak i ako nisu knjiženi, preporučuje se obratiti pažnju.
...
**Povrat/radni nalog**: raspon datuma filtrira prema datumu povratka, samo otisnuti povratci koji nisu fakturirani.nPovrati moraju biti generirani tako da se izvrši narudžba za radni nalog, a ne unosom ručno, inače neće biti vidljiva;
