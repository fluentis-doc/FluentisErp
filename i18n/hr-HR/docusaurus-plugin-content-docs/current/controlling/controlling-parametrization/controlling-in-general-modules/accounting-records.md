...
U svakoj knjigovodstvenoj evidenciji s predlošcima knjiženja kojim imaju aktiviranu opciju za upravljanje *Centrima troškova*, bit će vidljiv tab „Analitika“, posvećen vrednovanju analitičkog računovodstva po centru troškova. 
...
- ako **nije aktiviran**, opcija će omogućiti prikaz posebne kartice za upravljanje izravnim troškovima/prihodima projekta, koja je odvojena od analitičkog računovodstva. 
- ako **je aktivirano**, ova opcija učinit će polje „Projekti” vidljivim unutar kartice za upravljanje troškovnim centrima u analitičkom računovodstvu. Polje će biti moguće uređivati samo za dimenzije povezane s dimenzijom projekata.
:::
...
- ***Postupak pregleda stanja računa po mjestu troška***: omogućuje pregled ukupnih iznosa po centrima, kao i po centru i kontu, uz zbrajanje unutar strukture kontnog plana. 

## IZVJEŠTAJI OPĆEG RAČUNOVODSTVA
Unutar grupe *Ispisa analitike* dostupni su sljedeći izvještaji:
- ispis ***Analize centara troškova***: omogućuje grupiranje podataka o zapisima analitike prema unaprijed definiranim svojstvima, povlačenjem u tablicu za grupiranje.  
