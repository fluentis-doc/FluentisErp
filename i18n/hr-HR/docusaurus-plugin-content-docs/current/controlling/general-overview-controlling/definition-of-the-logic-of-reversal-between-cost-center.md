...
Nakon toga, centar održavanja, koji će biti valoriziran izravnim troškovima (poput troška zaposlenika) i neizravnim troškovima najma, bit će dalje raspoređen s drugim nositeljem (s ciklusom izračuna 2) na centar tokarenja i centar zavarivanja, primjerice na temelju radnih sati strojeva zabilježenih tijekom proizvodnje (povezujući centar s određenim strojem). 
