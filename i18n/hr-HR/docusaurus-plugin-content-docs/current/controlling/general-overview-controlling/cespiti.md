...
Iz perspektive kontrolinga važno je moći izračunati te amortizacijske stope s tehničkog stajališta, neovisno o fiskalnim i računovodstvenim pravilima, koja su često prilagođena drugačijim potrebama. Bitno je imati mogućnost zamjene povijesnog troška nabave s troškom zamjene, dakle ažurnijim troškom, te mogućnost određivanja tehničkog vijeka trajanja neovisno o službenim tablicama. Također, potrebno je omogućiti amortizaciju bez provjere preostale vrijednosti kako bi se u troškovima prikazao i stroj koji je računovodstveno već potpuno amortiziran.
...
Međutim, u upravljačkom računovodstvu to nije prihvatljivo jer, ako je sredstvo  nabavljeno 1. siječnja, treba uzeti u obzir 365 dana amortizacije, dok će za kupnju 31. prosinca biti samo jedan dan. Stoga je važno pažljivo procijeniti situaciju s osnovnim sredstvima – primjerice, kod poduzeća s dotrajalim strojevima koje treba obnoviti može biti korisno primijeniti amortizaciju "bez preostale vrijednosti" kako bi se izbjeglo precjenjivanje profitabilnosti proizvoda ili projekata.
