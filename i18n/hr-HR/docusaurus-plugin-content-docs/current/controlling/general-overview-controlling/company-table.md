...
Prva odluka koju treba donijeti odnosi se na vrstu kontrolinga koju tvrtka želi implementirati. Ako je cilj izgraditi sustav poslovnih centara međusobno povezanih logikom prijenosa vrijednosti troškova i prihoda, kako bi se omogućila analitička računovodstvena valorizacija, potrebno je otvoriti ***Tablicu tvrtke*** i označiti opciju upravljanja *Kontrolingom*, (nalazi se u kartici *Ostale postavke*).
