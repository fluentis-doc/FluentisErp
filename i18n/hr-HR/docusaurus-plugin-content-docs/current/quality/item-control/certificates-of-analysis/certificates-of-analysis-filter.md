...
Za dupliciranje postojećeg *certifikata s analize* u novi *certifikat s analize*, klikne se na *certifikat s analize* koji se želi duplicirati u prikazu i pritisne se tipka **Dupliciraj**. Možete se duplicirati samo jedan *certifikat s analize* istovremeno. Pojavit će se upit:  
...
> **Dupliciraj izvorne reference kontrolnih artikala**: označava ako se žele duplicirati redovi povezani s *Kontrolama artikala*.   
> **Duplicirane ostale izvorne reference**: označava ako se žele duplicirati redovi koji nisu povezani s *Kontrolama artikala*.   
