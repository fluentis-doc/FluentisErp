...
Obrazac se otvara putem putanje **Prodaja > Otpremnica > Otpremnica**
...
Za otvaranje pojedinosti o dokumentu, dovoljno ga je odabrati i dvaput kliknuti mišem ili kliknuti na gumb **Izmijeni** (omogućuje ulazak u pojedinosti i uređivanje) ili na gumb **Prikaži** (omogućuje ulazak u pojedinosti i pregled, ali ne i uređivanje).
...
> 2. aplikacija će započeti stvaranje dokumenta i otvoriti skočni prozor **Sažetak dupliciranja** gdje možete unijeti preostale podatke;  
