---
title: Automatsko generiranje obračuna provizije
sidebar_position: 1
---

Ovaj obrazac otvara se putem putanje *Prodaja > Trgovački predstavnici > Procedure > Automatsko generiranje obračuna provizije*.
...
- filtar za valutu dokumenta, kako bi se stvorio obračun predstavnika razlikovana po valuti;
...
U donjem dijelu, *Podaci za kreiranje obračuna provizija*, potrebno je navesti datum obračuna, njegov opis te mjesec/godinu koji služe kao referentno razdoblje za obračun doprinosa Enasarco.

:::tip Provizije prema naplaćenom i privremena računovodstvena knjiženja.
Za izračun zarađenih provizija uzimaju se u obzir SAMO zapisi u **konačnom** statusu, stoga će se eventualne uplate (čak i predujmovi) knjižene kao privremene - zanemariti.
:::

:::tip Provizije prema naplaćenom i bankovne mjenice (Ri.Ba.).
...
Dva polja **Broj dana nakon dospijeća za potvrde predane na naplatu uz klauzulu „uz dobru naplatu” i Broj dana nakon dospijeća za potvrde predane po naplati.** imaju važnu ulogu. Ako su popunjeni, dodaju se kašnjenja i u zbirnoj zaradi provizija.
...
Kartica *Povrati u prethodno stanje* omogućuje vam pronalaženje u kojoj su provizije dokumenata filtrirane, ili pronalaženje jedne ili više provizija prema filterima prisutnim u obrascu. Pomoću odgovarajućeg gumba za vraćanje moguće je poništiti stvaranje provizija agenata. Nije moguće vratiti provizije koje su već prošle kroz modul za primanje.

*Gumbi*:
> **Traži**: izvršava pretragu automatski izračunatih provizija.    
> **Povrat u prethodno stanje**: poništava stvaranje odabranih provizija.