...
> **Nova**: ovaj gumb omogućuje [Stvaranje nove fakture](/docs/sales/sales-invoices/invoicing/header).  
...
Povezanost između ručno stvorenog storno dokumenta u novom dokumentu u Zaglavlje > Odjeljak Status dokumenta nalazi se u poljima **Referentna faktura** i **Vrsta reference**.
