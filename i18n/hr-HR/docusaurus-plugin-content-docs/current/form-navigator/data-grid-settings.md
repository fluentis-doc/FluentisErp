...
**1.** otvoriti lijevo *Navigator obrasca* (Form navigator), otvoriti *Widgete rezultata* (Results Widgets), zatim definiciju tablice i odabrati objekt *Tablica* (Grid): dolje će se pojaviti *Kontrola tablice* (Grid Control) gdje se može označiti *Učitaj sve podatke* (Load all data) s maksimalnim brojem redaka koje treba uzeti u obzir - *Ograniči broj redaka* (Limit row number). 
