Jednom kada su postavljeni svi željeni *Filtri*, klikom na gumb *Traži* prikazat će se u tablici redak za svaku narudžbu koja je ispisana, potvrđena i nije izvršena ili je djelomično izvršena.
...
U tablici rezultata, korisnik ima mogućnost:
...
> **Proširi**: tipka za proširenje cijelog stabla narudžbi u donjoj tablici, kako bi se prikazali artikli koji se u njima nalaze;  
...
> **Odznači sve**: tipka za uklanjanje oznake svih artikala s popisa.  