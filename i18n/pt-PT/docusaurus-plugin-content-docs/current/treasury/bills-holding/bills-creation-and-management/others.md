...
Nesta última seção se podem memorizar as referências dos endossantes e dos fiadores. Esta ficha não tem uma gestão padrão particular.
...
| --- | --- |
| Salvar efeito | Salva o efeito na gestão. |
| Novo efeito | Cria um novo efeito. |
| Inserção vencimentos | Ativo quando é ativo o tab 'Referências vencimentos', permite de abrir uma ajuda vencimentos para associar um prazo das faturas no efeito em utilização. |
