...
O procedimento vai permitir juntar os encerramentos infra-anuais das várias sociedades presentes no banco de dados, para poder criar um balanço consolidado de grupo a imprimir ou valorizar num reclassificado de balanço.
...
| --- | --- |
| Criação consolidação | Executa a criação das escrituras de consolidação. |
