---
title: Basic Course Search 
sidebar_position: 2
---

The filter can be found on the path **Home > Employees > Training Courses > Basic Courses**.   

The data filter allows you to enter new *Basic courses* or search for existing ones to view, modify, or delete them.   

### ![](/img/neutral/common/search.png) Basic Course Search 
...
### ![](/img/neutral/common/new.png) Enter Basic Courses 

To enter new *Basic courses*, you must click the **New** button.   

### ![](/img/neutral/common/edit.png) Edit or ![](/img/neutral/common/view.png) View Basic Courses 
...
### ![](/img/neutral/common/duplicate.png) Duplicate Basic Courses 
...
> **Planned**: indicator of *Planned Training Course*.   
...
The button is enabled only if a single *Basic course* is selected from the results grid where a renewal is expected (*Course renewal data* with *Frequency* different from *zero*).   
...
> Other information inherited from the source *Basic course*: *Tutor*, *Tutor requirements*, *Normative requirements*, *Sector*, *Area*, *Course category*, the list of *Tasks*; from the *Basic Course - Renewal*: *Contents*, *Foreign presence*, *Efficacy evaluation*, *Scheduled hours*, and *Expected cost*.   
> Based on the *Tasks*, the *Employees* who hold those *Tasks* on the date of the course will be proposed.   
