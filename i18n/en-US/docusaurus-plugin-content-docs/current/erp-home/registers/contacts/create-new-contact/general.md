...
In the **Web Access (Accesso Web)** section, it is possible to enable access via Internet Explorer to the application, enabling the registry and assigning the username and password for access;
