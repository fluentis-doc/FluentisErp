...
Through this mask it is possible to account giro bills by vendor: the procedure will close the account linked to bills type inserted into list and will perform the survey of vendor payments inserted into list.
...
| Function | Meaning |
| --- | --- |
| Search | It searches the list of bills to be accounted. |
| Bills Accounting | It performs the accounting of the selected lines. |
