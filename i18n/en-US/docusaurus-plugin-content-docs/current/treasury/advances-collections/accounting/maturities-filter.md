---
title: Maturities Filter
sidebar_position: 2
---

The first mask is dedicated to the search filters of maturities to be collected: it is really important to remember that in this mask it is possible to view automatically only maturity values that have been anticipated, but also to set search flags in order to show all active maturity values, even the not anticipated ones.
...
| Function | Meaning |
| --- | --- |
| Search  | It searches the maturities to be accounted. |
