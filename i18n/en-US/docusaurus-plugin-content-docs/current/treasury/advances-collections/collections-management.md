...
Through this procedure the user can view the status of issued and/or presented sales invoices, in order to manage also the advance status manually.
...
| Function | Meaning |
| --- | --- |
| Search Invoices | Button through which it is possible to search the presented or printed invoices according to the current tabulator. |
