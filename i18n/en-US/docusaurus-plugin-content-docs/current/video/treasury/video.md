...
The first video covers the basic parameters and tables of the module, and it is recommended to watch it to understand the possible choices and settings even if it does not concern operational procedures.
