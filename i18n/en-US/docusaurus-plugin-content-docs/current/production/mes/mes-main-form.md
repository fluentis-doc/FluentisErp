...
For the selected row, on the right side of the grid, it is possible to view the default image inserted in the [Item Registry](/docs/erp-home/registers/items/create-new-items/item-registry/images); additionally, with a double-click, it will be displayed in full screen.       
