...
###     <Link to="/docs/planning/ms-master-scheduling/mrp">Fluentis MES</Link>
        <p><Link to="/docs/production/mes/configuration" className="bold-link">Installation (Installazione)</Link></p>
        <p>short guide on installing Fluentis MES (breve guida sull'installazione di Fluentis MES)</p>
