---
title: Closures Values
sidebar_position: 1
---

The mask is dedicated to view data calculated in the selected mid-year closure.
...
| Function | Meaning |
| --- | --- |
| Search Values | It searches data for the selected tabulator |
