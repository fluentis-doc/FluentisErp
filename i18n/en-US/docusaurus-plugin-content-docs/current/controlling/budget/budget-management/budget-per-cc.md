...
| Function | Meaning |
| --- | --- |
| Create from Sub-Budgets for Detail Accounts | It performs the procedure of generation of sub-budgets for detail accounts. |
...
| Import Data | Button to import a budget for C.C from Excel. |
