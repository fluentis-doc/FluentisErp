...
At the bottom, it is possible to enter the parameters that will be used by the procedure in case they have not been previously set in **Parameters for user**, **Intervention Types**, or **Project parameters**:
