...
**Solution / Description (Soluzione / Descrizione)**: Represents the code and description of the payment extension to apply.
...
**DL Art 62 (DL Art 62)**: flag that identifies the two installments of 30 and 60 days that will be used for calculating payment deadlines in invoices containing perishable goods according to Art. 62 of the Law Decree of January 24, 2012, no. 1.
