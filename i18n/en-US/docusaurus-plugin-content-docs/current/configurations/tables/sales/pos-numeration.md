---
title: POS Numeration
sidebar_position: 11
---

The POS numeration table enables the user to establish the different progressive numeration within the same year in order to be assigned to one or more POS types. 
...
| Prog. No. | Starting progressive number for POS numeration. |
