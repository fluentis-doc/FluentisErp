---
title: Order Grouping Parameters 
sidebar_position: 7
---
...
**Creating a sales order from offers**: in the case of fulfilling multiple quotes into an order, it is possible to group the quotes based on the following properties:
- **Document type**: quotes with the same [Type](/docs/configurations/tables/sales/sales-offer-type) will create a single order
...
- **Project**: quotes with the same project in [Header](/docs/sales/offers/insert-offer) will create a single order
- **Payment type and solution**: quotes with the same payment terms will create a single order
