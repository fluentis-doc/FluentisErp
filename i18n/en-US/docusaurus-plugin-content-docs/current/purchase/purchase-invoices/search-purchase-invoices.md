...
| Function | Meaning |
| --- | --- |
|  [Purchase Invoices Parameters](/docs/configurations/parameters/purchase/purchase-invoices-parameters)  | The procedure enables to configure and to view parameters of purchase invoices. |
|  [Purchase Invoices Accounting](/docs/purchase/purchase-invoices/accounting/purchase-invoices-accounting)  | The procedure enables the user to account the purchase invoices. |
