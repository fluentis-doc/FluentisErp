...
The form is opened via the path **Purchases > Price Lists > Supplier Price Lists (Acquisti > Listini > Listini fornitori)** and allows you to search, view, and create new supplier price lists.   
