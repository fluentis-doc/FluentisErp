...
<summary>Click for essential steps (Clicca per i passaggi fondamentali)</summary>
 
1. **Enter mandatory data (Inserisci i dati obbligatori)**: *Type* and *Supplier*. *Year*, *Number*, and *Insert date* will be proposed automatically.  
 
2. **Enter or modify optional header data (Inserisci o modifica i dati facoltativi)**: such as delivery dates, any *Discounts*, *Destination*, etc.  
