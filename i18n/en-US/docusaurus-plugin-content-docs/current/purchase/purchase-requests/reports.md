...
Access to the various invoice prints is done from the menu **Purchases > Purchase Requests > Reports (Acquisti > Richieste di acquisto > Stampe)**.

### RDA Print (Stampa RDA)
...
The first filters shown are those related to the header information of the documents, such as *Type*, *Document Number*, *Supplier*, *entry date (data di inserimento)*, and *Demand date*.    
In the “Advanced search (Ricerca avanzata)” groupbox, the states of the request that can be filtered can be checked. It is also possible to filter by *ITEM*, *Production job order*, or *Project* present in the purchase requests.    
