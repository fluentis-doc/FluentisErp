---
title: Execution from Purchase Order
sidebar_position: 1
---
...
| Function | Meaning |
| --- | --- |
| Search Purchase Orders | It enables the user to search the purchase orders. |
...
| Delete Registry Settings | It enables the user to delete register settings. |
| Transfer Items | It enables the user to transfer the selected items. |
| Forced Execution of Order | It enables the user to perform the forced execution of order. |
| Go to Upper Level | It enables the user to go up a level on list. |
| Go to Inferior Level | It enables the user to go down one level on list. |
| Find Object in the List | It enables the user to move objects of list. |
| Select All the Objects in the List | It enables the user to select all items from the list. |
| View/Hide the Selected Object Parent | It enables the user to view/hide the selected object parent. |
| View/Hide Orders Panel | It enables the user to view/hide orders panel. |
| Block Orders to Be Executed | It enables the user to block orders for the execution. |
