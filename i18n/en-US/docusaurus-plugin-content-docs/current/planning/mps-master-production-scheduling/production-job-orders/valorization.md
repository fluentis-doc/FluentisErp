...
The estimated cost is based on the work order list price (as long as the work order has not been created), at the time the work order is created it will be based on the price indicated in the item line.      
