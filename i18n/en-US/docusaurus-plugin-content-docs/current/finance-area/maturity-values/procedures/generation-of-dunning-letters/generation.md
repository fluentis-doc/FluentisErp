...
The generation of dunning letters enables the user to view and to select a part of active maturity values in the first tab, which have been opened in order to identify a subset of maturity values to be dunned.
...
| Function | Meaning |
| --- | --- |
| Search | Button to search the whole database of maturity values. |
| Generation of Dunning Letters | Button to generate the selected maturity values. The button is alternative to the generation button, that is in the following tabulator. |
