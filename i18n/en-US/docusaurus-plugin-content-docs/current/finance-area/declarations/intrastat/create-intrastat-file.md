...
| Function | Meaning |
| --- | --- |
| Search | It searches the Intrastat declarations for which it is possible to generate the electronic file. |
| Export on File | Button to create and to export the electronic file, with saving of file in a directory chosen by the user. |
