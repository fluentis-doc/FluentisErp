...
| --- | --- |
| Insérer | Il permet d'insérer un nouveau record dans la grille. |
| Supprimer | Il permet de supprimer le record par la grille (et les données 'matériaux' reliés). |
| Divers - Rechercher | Il recherche à l'intérieur de la liste articles de grille. |
