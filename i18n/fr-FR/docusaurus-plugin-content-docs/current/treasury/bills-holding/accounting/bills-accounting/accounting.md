...
À partir de ce masque s'avance à la comptabilisation effets: la procédure, selon les paramétrages de la cause comptable établie, ira à fermer les comptes clients reliés aux effets sélectionnés.

La partie supérieure du masque est dédiée au paramétrage des filtres de recherche.

La section de **Paramétrage de la comptabilisation** peut être prédéfinie à l'intérieur des paramètres du formulaire Portefeuille effets. Il se réfère à assigner la cause de comptabilité, les dates de référence pour l'enregistrement et les éventuels flag de comptabilisation et d'enregistrement provisoire.
