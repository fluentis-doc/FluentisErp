...
| --- | --- |
| Rechercher précédents | Rechercher la liste des créations exécutées. |
| Supprimer création | Avec ce bouton sera supprimé toute la comptabilisation effectuée, avec tous les paiements associés. |
| Supprimer le paiement | Le bouton exécute la restauration du paiement sélectionné. |
