...
|  [Cause/Description cause](/docs/configurations/tables/finance/ledger-records-templates/ledger-records-templates)  | Cause comptable utilisée pour la comptabilisation de la facture. |
