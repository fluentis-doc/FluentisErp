...
Tabelul se află pe calea **Configurare > Tabele > Management proiecte > Tip resurse**.

Permite inserarea resurselor noi (umane sau materiale) sau căutarea celor existente pentru a le vizualiza, modifica sau șterge.
