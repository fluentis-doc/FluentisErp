...
**Agr. vânz. TVA**: dacă este activ, în momentul creării ordinului, aplicația va verifica, dacă pentru articolul utilizat, este prezent un cod TVA agricol. Dacă nu este prezent, este utilizat codul TVA prezent în [registrul articolului](/docs/erp-home/registers/items/create-new-item);
