...
**Tip/Descriere**: utilizat în contabilizarea documentului. Pentru alte detalii verificati [utilizarea](/docs/configurations/tables/finance/ledger-records-templates/insert-ledger-records-templates/attributes-detail) în *înregistrările contabile* din aria *Administrativă*.
