...
Faptul că o anumită zi este sărbătoare legală, permite ca, în momentul în care se generează **Calendarul capacităților productive**, aplicația să genereze automat disponibilitatea *Resursei productive* doar pentru zilele care, în [Calendarul de lucru](/docs/configurations/tables/production/factory-calendar) nu sunt sărbători legale.
