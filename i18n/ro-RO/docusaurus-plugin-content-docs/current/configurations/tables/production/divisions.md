...
Tabel pentru codificarea diverselor secții de producție.
...
**Secţie** și **Descriere**: reprezintă codul și descrierea secției;  
**Dată inserare**: reprezintă data de inserare a secției;  
**Dată modificare**: reprezintă data modificării secției.