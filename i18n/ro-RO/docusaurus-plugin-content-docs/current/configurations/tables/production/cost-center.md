...
Permite inserarea tarifelor care vor fi asociate mașinii și grupului de manoperă pentru a putea valoriza fazele de prelucrare ale diverselor centre de lucru.
...
Este necesară inserarea macar a datelor obligatorii: **Cod** centru de cost și  **Cost**. Dacă nu se specifică nicio **UM**, tariful inserat în cost va fi interpretat ca tarif orar.
