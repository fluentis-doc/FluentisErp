...
Se află pe calea **Tabele > Setări generale > Transport** și conține tipurile de transport (pe uscat, pe mare, pe aer etc) utilizate de aplicație.
...
**Cod/Descriere**: indicare un codice univoco per la tipologia di spedizione e relativa descrizione.
