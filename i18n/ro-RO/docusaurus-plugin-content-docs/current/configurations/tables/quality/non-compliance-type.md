...
**Neconformitate la furnizor**: indică faptul că linia este o neconformitate la furnizor, deci la crearea unei noi neconformități de acest tip se va activa și posibilitatea de a insera [Furnizorul](/docs/erp-home/registers/contacts/create-new-contact/accounting-data/accounting-data-intro) responsabil;
