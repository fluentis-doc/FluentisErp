...
**Cost predefinit materiale ofertă**: în acest câmp se poate insera *Tip cost sursă* de utilizat ca sumă de pornire pentru calculul venitului din *Materialele* unei [oferte ierarhice](/docs/sales/offers/new-offer/group-items).
**Articol ordine resurse din ofertă**: în acest câmp se poate insera articolul codificat care va fi asociat resurselor unei *Oferte*, pentru crearea rândurilor ordinului din [oferta ierarhică](/docs/sales/offers/new-offer/group-items).
