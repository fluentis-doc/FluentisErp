...
Parametrii avizelor de vânzare permit setarea de bază pentru gestionarea corectă şi în funcţie de specificul cerut de fiecare societate.
...
**Plăţi**: specifică valoarea utilizată pentru plata avizului în cazul executării multiple a ordinelor: primul ordin, registru sau selecţie manuală 
...
**Încărcare/Descărcare automată**: dacă este activ, descărcarea avizului va fi efectuată automat la activarea flagului Listat. Dacă nu este activ, descărcarea se poate face cu butonul (vezi [Inserare aviz](/docs/sales/sales-delivery-notes/insert-delivery-notes/insert-delivery-note)) sau cu procedura relativă.
