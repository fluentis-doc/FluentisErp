...
Dacă flagul este activ, timpul calculat va fi dat de suma valorii **Lead Time Fix** (introdusă lângă flag) și valoarea **Lead Time Analiză** din tabul [Calitate](/docs/erp-home/registers/items/create-new-item) al *Registrului articolului*, deci în acest caz timpul pe faze nu este considerat, iar data de început este recalculată pe baza *Calendarului de Fabrică*. Dacă flagul nu este activ, data de început va fi recalculată luând în considerare fazele, fazele alternative și *Calendarul centrelor de lucru*.
