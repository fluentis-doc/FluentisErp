...
Form-ul se află în **Parameteri > Logistică > Parameteri dispoziții de livrare** permite parametrizarea documentelor. 
...
**Prioritate parametri dispoziție livrare**: permite indicarea unei **Gestiunii** și a unui **Șablon** care vor fi utilizate implicit la descărcarea dispoziției de livrare.  
**Control disponibilitate**: dacă este activ, înseamnă că va fi verificată disponibilitatea articolului.  
**Disponibilitate obligatorie**: dacă este activ, înseamnă că disponibilitatea articolului va fi obligatorie, şi anume cantitatea nu va putea fi superioară disponibilităţii.  
**Exclude ordine clienţi**: dacă este activ, înseamnă că rezervarea ordinelor clienţi nu va fi considerată la calcularea disponibilităţii articolului dispoziției.  
...
În acest form puteți defini parametrii pentru funcționarea dispoziției de livrare în Fluentis Mobile.
...
- *Descărcare palet pentru confirmare transfer*;
