...
**Nu utiliza dimensiuni**: dacă este activ, aplicația nu va controla dimensiunile articoelor și UdI pentru a le confrunta cu [Mașina](/docs/configurations/tables/logistics/motorvehicle), evitând astfel blocaje în expediție. Cu acest parametru inactiv, dacă volumul articolelor este superior volumului mașinii, aplicația va sugera mai multe mașini;            
