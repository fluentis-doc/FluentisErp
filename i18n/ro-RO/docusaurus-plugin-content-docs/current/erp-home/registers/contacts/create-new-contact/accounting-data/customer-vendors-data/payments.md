...
**Grupare note credit în efecte**: permite stornarea, la crearea efectelor, și a notelor de credit care au tipul plății de gestionat în efecte. Dacă flag-ul nu este activ, angajamentele relative la credit note nu vor mai fi afișate în form-ul de căutare al angajamentelor pentru procedura [Creare efecte din angajamente](/docs/treasury/bills-holding/procedures/bills-acquisition-from-maturity-values/bills-acquisition-from-maturity-values-intro). Acest parametru trebuie să fie combinat cu flag-ul **Grupează credit note după data scadenţei** din [Parametri portofoliu efecte](/docs/configurations/parameters/treasury/bills-portfolio-parameters)
