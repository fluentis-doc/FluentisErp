...
:::note Notă
Dacă parametrul *Gestiune Controlling*, situat în *Alte setări* din tabelul [**Societate**](/docs/configurations/tables/general-settings/company) este dezactivat, acest câmp este utilizat pentru a insera centrul de cost. 
:::
...
[Centre companie](/docs/configurations/tables/controlling/analytical-accounting/corporate-centers).