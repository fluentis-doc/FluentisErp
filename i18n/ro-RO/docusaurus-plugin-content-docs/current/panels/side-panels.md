...
Fluentis oferă posibilitatea de a seta diverse funcționalități:

- **[Instrumente](/docs/applications/applications-intro)**: conține aplicațiile complementare,

- **[Object Navigator](/docs/object-navigator/object-navigator-intro)**: conține toate proprietățile obiectului curent, utile pentru personalizarea form-urilor prin adăugarea de date sau informații suplimentare,

- **Context Panel**: este un tablou de bord contextualizat la selecția activă,
