---
title: Gestiune suport plăți
sidebar_position: 2
---

Această fereastră servește gestionării datelor bancare prevăzute pentru plăți (și eventual pentru încasări). În registrele clienți/furnizori se poate defini contul analitic al băncii pentru plată predefinită: pe baza acestuia, fiecare angajament, în momentul creării sale, va avea acest cont care va putea fi gestionat și modificat de procedura Gestiune suport plăți.

În afara acestei funcționalități, fereastra permite vizualizarea listei în care angajamentul a fost plătit și permite memorizarea manuală a primirii avizului de plată, a controlului său și al confirmării expedierii lui cu ajutorul flag-urilor relative din grid.
...
| --- | --- |
| Caută | Buton pentru căutarea angajamentelor. |
