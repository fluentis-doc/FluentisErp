...
- definire gli [*Automezzi*](/docs/configurations/tables/logistics/motorvehicle/)   
- definire gli [*Autisti*](/docs/configurations/tables/logistics/motorvehicle-drivers)      
