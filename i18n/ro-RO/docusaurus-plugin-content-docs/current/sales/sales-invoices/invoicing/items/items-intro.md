...
**Cantitatea alternativa**: este propusa valoarea relativa la U.M. alternativa, calculata prin multiplicarea sau divizarea cantitatii gestionale (relativa la U.M. principala) cu factorul de conversie inserat in registrul articolului.
...
| Variaza - Caută ultimele preturi | Permite cautarea conditiilor de vanzare pentru articol in documentele de vanzare precedente si permite preluarea pretului si a discountului. |
...
| Import articole | Permite importul de articole dintr-un document. |
