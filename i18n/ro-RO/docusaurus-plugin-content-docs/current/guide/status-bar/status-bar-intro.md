...
În partea inferioară a ferestrei principale a aplicației Fluentis este bara de stare care conține o serie de informații:





![](/img/ro-RO/guide/panels/status-bar/status-bar/image01.png)

1. **Activitate 3**/0**: **permite o conexiune rapidă cu gestionarea activităților în așteptare (care derivă din procedurile WorkFlow configurate),  gestionarea DashBoards care permite o sinteză rapidă a activităților cu o interfață statistică puternică și ușor de personalizat.
