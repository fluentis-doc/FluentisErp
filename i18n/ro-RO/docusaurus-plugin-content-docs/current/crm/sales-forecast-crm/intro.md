...
Modulul Previzuni de vânzări din Fluentis ERP oferă instrumente avansate pentru planificarea, monitorizarea și compararea vânzărilor așteptate cu datele reale.

### Gestionare previziuni de vânzări
Această funcționalitate permite crearea și gestionarea previziunilor de vânzări direct din Sales Forecast >Gestionare previziuni de vânzări.

### Închidere previziuni de vânzări

Acest raport permite compararea dintre previziuni și rezultate reale, prin importul de documente precum facturi, ordine sau oportunități.
