...
Cu ajutorul filtrelor se poate vizualiza: un singur contact, mai multe contacte aparținând aceleiași tipologii (*Tip contact*), mai multe contacte aparținând aceleiași categorii comerciale (*Categorie comercială*). De asemenea, se poate filtra după *Agentul principal* indicat pe contact, căruia îi sunt asociate și filtrele referitoare la *Concurenți* și *Sector de utilizare*, sau după alte filtre.

#### Butoane specifice  
> **Caută**: permite afișarea contactelor importate sau introduse manual, împreună cu caracteristicile lor.
> **Conversie la client**: cu acest buton este posibilă convertirea unui contact CRM într-un *Client*; datele introduse în contact vor fi copiate în noul registru; butonul este activ pentru *Tipuri contact* care nu au activ flag-ul client.
...
- **Funnel pe calitate contact**: în această secțiune este afișată grafic evoluția gestionării contactelor pe baza Calității.