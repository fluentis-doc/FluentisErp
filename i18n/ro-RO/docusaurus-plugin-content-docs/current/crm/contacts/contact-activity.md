...
All’interno di questa tab è possibile trascinare, mediante una semplice operazione di drag and drop, le attività presenti nel Workflow o, in alternativa, inserire manualmente una nuova attività.
...
**Tipo Attività**: è possibile specificare la tipologia di attività effettuata per il contatto; le tipologie vengono definite nella tabella [Tipi Attività](/docs/configurations/tables/crm/activity/activity-type);     
