...
![](/img/it-it/applications/crm/contacts/contact-references.png)

Per inserire un nuovo Riferimento, è necessario premere sul pulsante della ribbon bar ![](/img/it-it/applications/crm/contacts/new-reference.png), che compare nel momento in cui si è all’interno di questa tab.
