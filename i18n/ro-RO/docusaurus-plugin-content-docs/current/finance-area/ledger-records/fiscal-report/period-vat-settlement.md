---
title: Lichidare TVA periodică
sidebar_position: 5
---

Cu această procedură de listare se calculează TVA-ul pentru perioada de referință: pentru acest raport nu este obligatoriu să fie deja listate registrele TVA ale perioadei, dar trebuie să fie deja listată definitiv lichidarea TVA pentru perioada precedentă (sau încărcarea manuală în tabelul ‘Vărsământ TVA' care la fel blochează perioada TVA în contabilitate) cu scopul de a reporta eventualul credit al perioadei precedente.
...
RIBBON BAR: reprezintă meniul Form-ului în discuţie. Mai precis, aria în care se pot efectua acţiuni. Prezentăm în continuare lista cu funcţionalităţile posibile în tabul curent:
