...
Audit Trail reprezintă o parte aplicațională care permite configurarea unei forme de LOG capabil să urmărească orice activitate în Fluentis, din partea oricărui operator.

Foarte utilă și uneori obligatorie în anumite domenii de activitate în care este necesar să se producă documente referitoare la „cine a efectuat”, „ce activitate” și, în special, „când”, adică într-un anumit interval de timp.

Este posibil să se producă loguri evidențiind și care valori au fost modificate în raport cu orice date.
