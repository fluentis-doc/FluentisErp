...
**Tipo scheda**: contiene la [tipologia di Scheda tecnica](/docs/quality/item-control/data-sheets/new-sheet); essa può essere impostata di default nei [Parametri](/docs/configurations/parameters/quality/item-control);        
**Codice**: è un codice alfanumerico precodificabile con la [tipologia di Scheda tecnica](/docs/quality/item-control/data-sheets/new-sheet);                    
...
**Responsabile**: è possibile inserire un Dipendente responsabile della scheda; esso è settabile di default nei [Parametri](/docs/configurations/parameters/quality/item-control);          
...
![](/img/neutral/common/control.png) Crea un nuovo [Piano di controllo](/docs/quality/item-control/control-plans/new-plan), quindi il documento che sarà l'istruzione operativa per il rilevamento di determinati valori. La creazione del Piano creerà un documento legato alla scheda tecnica, della quale riportera le Proprietà con il flag **Da rilevare**.
