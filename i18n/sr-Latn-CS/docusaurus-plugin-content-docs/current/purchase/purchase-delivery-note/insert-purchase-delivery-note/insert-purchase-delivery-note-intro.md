---
title: Inserimento DDT di acquisto - sezione fissa
sidebar_position: 1
---
...
In questa form viene proposta automaticamente la data corrente, modificabile in base al documento.

Per continuare la creazione del DDT di acquisto, l'utente deve inserire i campi obbligatori:

- il tipo DDT predefinito in  Configurazione > Tabelle >Acquisti>Tipi DDT di acquisto];
