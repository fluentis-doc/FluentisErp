...
Ovaj postupak koristi se prilikom prijema robe, za identifikaciju artikala, kreiranje i utovar primke.
...
Nakon odabira jedne ili više dobavljačkih narudžbi, moguće je pregledati neispunjene i djelomično ispunjene artikle pritiskom na gumb *Pregled*, dok se putem gumba *Kreiraj primku* može započeti unos artikala koji će biti uključeni u primku.

Glavni obrazac se sastoji se od sljedećih kartica: 

- **Kreiraj primku**  
Nakon odabira narudžbe, putem gumba *Kreiraj primku* moguće je otvoriti formu na kartici *Kreiraj primku*, gdje će se fokus automatski postaviti na polje *Primka* kako bi se prvo unio broj dokumenta. Također, bit će prikazane informacije o prvom artiklu na dobavljačkoj narudžbi, kao i informacije o glavi same narudžbe.

> **Skladište**: označava skladište u kojem će se obaviti promjene;         
> **Predložak skladišta**: označava predložak knjiženja promjene u skladištu;     
> **Tip otpremnice/primke**: označava tip primke koji će se koristiti pri stvaranju dokumenta o prijevozu;                  
...
> **Datum isporuke**: označava datum isporuke lota;          
> **Naručena količina**: označava naručenu količinu;   
...
Pomoću polja **Barkod** (koristeći čitač barkoda) moguće je unijeti podatke o lotu, lokaciji, očitanoj količini i artiklu u slučaju da se želi utovariti drugi artikl osim onog koji je predložen, ali koji je ipak prisutan u prethodno odabranim narudžbama. Nakon unosa podataka o trenutačnom artiklu, mogu se potvrditi pritiskom na gumb **Potvrda**.       
Kada su potvrđeni svi retci narudžbe, automatski ćete biti prebačeni na kartici **Detalji otpremnice/primke**, gdje pomoću gumba **Zatvori** možete spremiti dostavnicu i izvršiti odgovarajuće promjene u skladištu.  

**Posebni gumbi**
> **Potvrda**: potvrđuje unesene podatke za odabrani artikl;             
> **Potvrda + Ispis**: potvrđuje unesene podatke za odabrani artikl i otvara skočni prozor koji omogućuje ispis naljepnica;      
