...
**Listino di vendita**: è possibile collegare un [Listino](/docs/sales/sales-price-list/sales-price-list/insert-sales-price-list/) di vendita da cui prendere le informazioni;
