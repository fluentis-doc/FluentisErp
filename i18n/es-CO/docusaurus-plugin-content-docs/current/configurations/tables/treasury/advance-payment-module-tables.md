...
En esta tabla se definen los posibles tipos de [**documento de anticipo**](/docs/treasury/advance/advances-collections) de facturas y sus parámetros respectivos.
...
**Tipo de adquisición:** las operaciones posibles son Vencimientos / Facturas. Esta opción solo controla la forma en que se muestran los datos en la pantalla de búsqueda para la creación del nuevo documento de anticipo, es decir, si se podrá seleccionar la factura completa o los vencimientos individuales de la factura. En todo caso, desde el punto de vista de la base de datos, de todas formas se gestionan los vencimientos (todos) incluso en el caso del modo Facturas.

**Numeración:** es necesario configurar una numeración desde la tabla respectiva de numeradores para este tipo de documento.

**Banco C/C:** (cuenta / cuenta detallada descripción): introduzca aquí la cuenta detallada que se utilizará en los registros contables relativos a la cuenta corriente bancaria.
