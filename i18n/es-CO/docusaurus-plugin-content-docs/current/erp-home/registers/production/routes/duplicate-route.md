---
title: Ciclos de producción duplicados
sidebar_position: 5
---

La **duplicación de ciclos de trabajo** permite utilizar filtros para buscar el/los ciclos de los cuales se desea partir para la duplicación del nuevo ciclo que se quiere crear.

Una vez configurados los filtros y haciendo clic en el botón de **búsqueda**, en la cuadrícula central se muestran los resultados de la búsqueda.
...
> **duplicación de ciclos de trabajo**: botón que activa el procedimiento que permite duplicar un ciclo de trabajo.
