...
#### De fecha de inserción...A fecha de inserción
...
#### Fecha mercancía lista 

#### Fecha inicio / fecha fin de validez {#validity-date}
...
#### Rokovi plaćanja za kvarljivu robu
...
#### Lista de precios de compra {#purchase-price-list}
...
#### Lista de precios para clientes {#sales-price-list}
...
#### Naturaleza del artículo {#item-nature}
...
#### Zonas de entrega {#delivery-zone}
