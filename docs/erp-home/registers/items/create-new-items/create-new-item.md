...
Le caratteristiche fondamentali e obbligatorie che ogni articolo deve avere e che troviamo nella prima parte della form sono: la [**Classe**](/docs/guide/glossary/glossary-intro#item-class), il [**Codice**](/docs/guide/glossary/glossary-intro#item-code), una breve **Descrizione** e l'[**Unità di misura**](/docs/guide/glossary/glossary-intro#unit-of-measurement).
