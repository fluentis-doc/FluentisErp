...
Nel caso di inserimento di una nuova riclassificazione, all'apertura della maschera è necessario impostare il codice univoco di 5 caratteri alfanumerici e la descrizione della riclassificazione, inserire il modello di riclassificazione e richiamare i dati della chiusura conti infrannuale da utilizzare. Nel caso in cui sia stato impostato il flag di ‘Consolidato' sarà possibile richiamare il codice del consolidamento intersocietario da gestire nel riclassificato.
