...
**Considera anche le alternative dei materiali**: se attivo, nel momento della pianificazione della commessa la procedura dovrà andare a considerare anche le alternative dei materiali, presenti nel tab *alternative* della [Distinta base](/docs/erp-home/registers/production/bill-of-materials/assemblies/structure-management), nel caso in cui non ci sia disponibilità sufficiente per il materiale principale indicato in distinta; in assenza di disponibilità anche dei materiali alternativi, la pianificazione proporrà un ordine di reintegro del materiale principale; il flag viene considerato solo se è attivo il flag **Considera la disponibilità**;

**Considera solo materiali alternativi**: si attiva solamente quando il flag **Considera anche le alternative dei materiali** è attivo; se attivo questo flag viene considerato il solo materiale con quantità sufficiente a coprire l'intero fabbisogno richiesto (non viene permessa la proposta di copertura da parte di più materiali contemporaneamente); in assenza di disponibilità anche dei materiali alternativi, la pianificazione proporrà un ordine di reintegro del materiale principale sufficiente a coprire il fabbisogno richiesto; il flag viene considerato solo se è attivo il flag **Considera la disponibilità**;
