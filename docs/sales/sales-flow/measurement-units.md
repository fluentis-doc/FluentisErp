...
Nei documenti, l'unità di misura principale viene mostrata nella griglia degli [Articoli](/docs/sales/sales-delivery-notes/insert-delivery-notes/items), mentre il widget dell'unità di misura alternativa è visibile nel tab "Dati articolo", contenente i campi "Quantità Alternativa" e "Prezzo Unità di Misura Alternativa", ma solo se il flag "Gestione Doppia Unità di Misura" è attivo nei parametri del modulo.
