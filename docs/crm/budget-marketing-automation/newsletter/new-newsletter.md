...
Nella sezione spprastante Recipient information, sono presenti alcuni campi per completare l'email:

**Destinatario aggiuntivo**: il campo permette di indicare i destinatari aggiuntivi per le email in cc., selezionandoli tra i riferimenti dei contatti CRM o tra gli utenti di Fluentis;
...
In fondo sono presenti i bottoni: 
**Invia email** : che apre un riepilogo degli indirizzi a cui verrà inviata la newsletter. Confermando, verrà inviata la email. 
