...
Una volta concordati i contratti con i fornitori e creata la commessa di acquisto, questa può essere evasa all'interno degli ordini fornitore mediante il pulsante di [Evasione da progetto](/docs/purchase/purchase-orders/insert-purchase-orders/header-procedures).   
