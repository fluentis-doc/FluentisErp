...
- **Classe**: riguarda la classe articolo destinataria della politica di sconto;        
- **Categoria sconto acquisti**: contiene la categoria di sconto definita per l'anagrafica e la classe articolo;      
...
Nella seconda griglia vengono definiti gli **Sconti** da proporre nelle combinazioni della prima griglia. Gli sconti verranno proposti nei documenti intestati all'anagrafica per quella determinata classe articolo. 