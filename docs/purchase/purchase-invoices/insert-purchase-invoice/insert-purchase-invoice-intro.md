...
- **Fornitore** può essere inserito usando l'[help di campo](/docs/guide/operations-with-data/manual-entry-or-help-and-data-selection) oppure manualmente;
...
> - [Testata](/docs/purchase/purchase-invoices/insert-purchase-invoice/header) e le sue [Procedure](/docs/purchase/purchase-invoices/insert-purchase-invoice/header-procedures/automatic-loading-on-warehouse)
