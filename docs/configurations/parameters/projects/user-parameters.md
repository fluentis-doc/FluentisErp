...
**Tipo nota spese**: indica la Tipologia di Nota spese da proporre di default per questo operatore, nel momento in cui verrà generata la nuova nota spese per questa risorsa-operatore. 
