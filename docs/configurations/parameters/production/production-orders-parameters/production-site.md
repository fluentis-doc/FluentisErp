...
Il campo **Contatto** nel Sito di Produzione viene utilizzato nelle **spedizioni**, per proporre l'Indirizzo del luogo di carico, quando si seleziona il sito di produzione di riferimento.  
