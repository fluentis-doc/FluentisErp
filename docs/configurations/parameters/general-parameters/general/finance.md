...
**Utilizza il peso del documento nell'Intrastat acquisti / Venite**: Abilitando (nel campo Valore) il flag (parametro di tipo booleano) rispettivamente per ognuno dei due parametri 
