...
- **Livello di servizio di default**: la combo box permette di selezionare da una lista fissa pre-caricata una tipologia di servizio per i bonifici quali a esempio *Istantaneo* , *Pago PA*, *Urgente* eccetera. Il valore viene comunque riportato nella testata della distinta di bonifico per una eventuale modifica.