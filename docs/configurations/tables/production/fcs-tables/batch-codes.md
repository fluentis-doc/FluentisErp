...
**Inserimento Codici accorpamento**

Per poter inserire nuove codifiche è necessario cliccare nella griglia sulla prima riga vuota oppure premere il pulsante **Nuovo**. 

Per il nuovo record si devono inserire almeno il campo obbligatorio richiesto dal programma: il **Codice**.
