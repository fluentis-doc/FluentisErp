...
- **Autista assegnato**: permette di indicare l'[Autista assegnato](/docs/configurations/tables/logistics/motorvehicle-drivers) all'automezzo;        
...
**Periodo inattività automezzo** che permette di inserire i seguenti valori:
