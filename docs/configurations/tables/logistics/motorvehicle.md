...
La tabella si trova sul percorso **Tabelle > Logistica > Automezzi**.
...
Questa maschera si compone di due griglie: nella prima si inseriscono **Tipo** e **Descrizione**; nella seconda è possibile inserire le configurazioni degli Automezzi inseriti nella prima griglia.
...
> **Unità di misura volume**: indica l'unità di misura con cui è espresso il **Volume**.  
> **Numero unità di carico contenibili**: indica il numeromassimo di unità di carico che possono essere contenute nell'automezzo.
