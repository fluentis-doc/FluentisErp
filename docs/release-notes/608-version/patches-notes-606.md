...
> - ARM:
>> - Correzione proposta di codice oggetto quando si personalizza una tabella in un oggetto   
>> - Correzione oggetto snapshot nei collegamenti alla tabella/applicazione snapshot su linux 
