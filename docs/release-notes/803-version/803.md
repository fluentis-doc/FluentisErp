...
Cordiali saluti.
```
**Check-list**: E' stata implementata la gestione dei pesi di importanza della domanda nell'abito della medesima *Categoria domanda*; i pesi sono espressi in percentuale. Questi valori verranno utilizzati nelle *Valutazioni iniziali e periodiche* del modulo di *Qualificazione fornitori*.  
...
**Valutazioni iniziali e periodiche**: E' stato implementato l'utilizzo della gestione dei pesi di importanza della domanda implementato nella gestione delle *Check-list* del modulo *Documenti di origine interna*. Il *Peso (%)*, assegnato ad ogni singola domanda della *Check-list*, viene qui trasformato in valore sulla base della *Valutazione rilevata*. Questo valore può essere utilizzato nelle analisi sull'argomento. 
