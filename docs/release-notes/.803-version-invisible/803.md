...
**Giacenza operativa**: Integrata in Analisi disponibilità la giacenza per fase generata dagli avanzamenti di produzione (intermedi di lavorazione), nel dettaglio dell'analisi disponibiità sono ora presenti anche i documenti che generano domanda e offerta nella giacenza per fase (fasi di lavorazione e documenti di conto lavoro di fase). E' stato introdotto il concetto di Giacenza operativa calcolata dalla giacenza totale detratta della giacenza per fase.
