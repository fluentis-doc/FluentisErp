...
> -	FI - La stampa CU dati previdenziali viene riportata correttamente (#TT01180/26)
...
> -	SD - Inserita la possibilità di selezionare più articoli nell'Help articoli. **Attenzione! Questa modifica può impattare sui profili** (#TT02312/24)
...
> -	PR - Stampa dilazione media incassi: revisione proposta della data scadenza nel report (#TT05491/25)
...
> -	SH - Risolto bug per aggiungere moduli custom allo script delle importazioni Excel (#TT05655/25)
...
> -	Aggiunta del flag StartTls sul connettore Mail del servizio BizLink.
...
> -	CO - Elaborazione periodi - ottimizzazione (#TT05417/25)
> -	FI - Creazione registrazioni contabili: risolto problema in fase di inserimento registrazioni in prima nota (#TT05213/25)
...
> -	WM - Aggiunto parametro ShowItemsArchived (default: false) all'API WM/ItemsAvailability/getItemsAvailability (#TT05322/25)
...
> -	FI - Creazione registrazione contabile da documenti acquisto in entrata: revisione modifica e salvataggio della data competenza in registrazione contabile. **Attenzione! Questa modifica può impattare sui profili** (#TT03307/25)
...
> -	MES - Corretto il calcolo della quantità impegnata nel caso venisse inserita una quantità negativa in un componente dell'ordine di produzione (#TT04892/25)
...
> -	FI - Corretto comportamento del flag Contabilizzato nel compenso percipiente, editabile se non contabilizzato con la procedura automatica e bloccato nel caso contrario. **Attenzione! Questa modifica può impattare sui profili** (#TT05242/25)
...
> -	FI - per la localizzazione IT, nelle griglie che mostrano i saldi dei sottoconti ora si visualizza la data fine validità di ogni sottoconto. La contabilizzazione ora testa inizialmente se ci sono sottoconti con data fine validità antecedente alla data di riapertura conti e in caso blocca la contabilizzazione. **Attenzione! Questa modifica può impattare sui profili** (#TT04124/25)
...
> -	FI - risolto errore di mancata registrazione del pagamento automatico nella contabilizzazione della fattura fornitore (#TT02936/25) 
> -	FI - Calcolo provvigioni: risolto problema nella visualizzazione degli agenti nella maschera di calcolo provvigioni con tipo documento considerato per l’imponibile provvigionale su pagamento totale. **Attenzione! Questa modifica può impattare sui profili** (#TT04896/25)
...
> -	FI - Creazione registrazione contabile cespiti: risolto problema nella registrazione dei cespiti utilizzando la funzionalità “Suddividi cespite” (#TT04778/25) 
> -	FI - Risolto il caso relativo alla gestione del tasso di cambio diretto nei documenti e corretta l’eccezione causata da una divisione per zero (#TT04986/25) 
...
> -	PR - Corretto il comportamento degli help di ricerca manuale degli ordini clienti e fornitori nel cashflow per errori nel filtraggio dei dati (#TT04002/25) 
> -	SH - Risoluzione errore che impediva l’importazione Web API del ‘Tipo codice lotto’ degli articoli (#TT04840/25) 
> -	SCM - Corretto, dopo il rollback, l’eliminazione dell’estensione nel documento (#TT04933/25) 
> -	SD - Associazione Tipi Listini di Vendita: premendo Nuovo si aprirà la form di inserimento di una nuova associazione. **Attenzione! Questa modifica può impattare sui profili** (#TT03101/25)    
...
> -	FI - Corretta la mancata registrazione del pagamento automatico in fase di contabilizzazione della fattura (#TT02936/25) 
...
> -	SD - Ordini Clienti Diagramma Evasione: Corretto diagramma nel caso ci siano delle note di accredito collegate alla fattura che è nata dal ddt che ha evaso un ordine cliente collegato ad una offerta (#TT01207/25) 
> -	SD - Ottimizzazione dell'importazione WebApi - vendite (#TT04576/25) 
...
> -	Arm - Aggiunti i report di riciclo acquisti (Stampe CONAI) nel menu standard (#TT04523/25) 
...
> -	SH - Chiusura tabella Aree. **Attenzione! Questa modifica può impattare sui profili** (#T03006/24) 
> -	SH - webapi di import FSLedgerAccount, revisione gestione destinatari/destinazioni, valorizzazione campo di gestione fatture elettroniche (#TT04641/25) 
...
> -	CO - Scritture di Rettifica: abilitata la possibilità di esportare i dati della griglia. **Attenzione! Questa modifica può impattare sui profili** (#TT04136/25)
> -	FI - Comunicazione liquidazioni periodiche iva: Risolto problema in fase di creazione LIPE (#TT04659/25) 
> -	FI - contabilizzazione compensi su compenso creato da liquidazione agenti, blocco del ricalcolo enasarco (#TT04577/25) 
> -	FI, PR - abilitata la multi-selezione nei campi combo per le form Pagamenti fornitori, Creazione automatica pagamenti fornitori e Gestione appoggio pagamenti. **Attenzione! Questa modifica può impattare sui profili** (#TT03917/25) 
...
> -	SD - Abilitata la possibilità di filtrare sul campo Tipo documento della griglia Lista Agenti nelle form Amministrazione > Percipienti > Procedure > Calcolo provvigioni e Vendita > Agenti > Procedure > Creazione automatica Liquidazioni provvigioni. **Attenzione! Questa modifica può impattare sui profili** (#TT04343/25) 
...
> -	FI - Creazione compenso da documenti di acquisto in entrata: risolto errore in fase di creazione del compenso dovuto a una descrizione troppo lunga e rivisti i calcoli nel riepilogo dati IVA (#TT02622/25) 
...
> -	SD - Listini di Vendita: Aggiunto un controllo sul tipo conto in fase di creazione di listini di vendita personalizzati per permettere la creazione di listini intestati solo a conti di tipo cliente. **Attenzione! Questa modifica può impattare sui profili** (#TT04472/25) 
...
> -	SD - Modificata la logica della stampa Provvigioni maturate che ora mostra la provvigione anche se il totale fattura è zero, nel caso di storno acconti, e l’agente ha il criterio di maturazione a fattura emessa (#TT04367/25)
...
> -	FI - SafTGeneralLedgerEntryFilterResults - Aggiunta l’opzione “Grouped” con valore predefinito 0. **Attenzione! Questa modifica può impattare sui profili** (#TT04178/25) 
...
> -	SD - Abilitata la possibilità di modificare la Data consegna e la Data merce pronta negli Ordini Clienti che hanno generato automaticamente il Progetto e la Commessa di Produzione. Le modifiche nel SalesOrder object form possono avere un impatto sui profili (#TT03882/25) 
...
> -	SD - L'Evasione di un Ordine cliente in DDT o Fattura accompagnatoria non comporta la modifica della data e dell'ora di inizio trasporto: vengono mantenute le informazioni presenti nel documento prima dell'evasione (#TT03386/25) 
...
> -	WM - Corretto calcolo analisi disponibilità su Scarichi di Produzione e calcolo Giacenza operativa per versamenti su ultima fase (#TT04304/25) 
...
> -	WMS - Corretta anomalia nel tab articoli delle forma gestione spunta e conferma picking nella quale non veniva visualizzato il corretto numero di decimali. **Attenzione! Questa modifica può impattare sui profili** (#TT04208/25) 

### Patch 707.1-0049 - 03/10/2025

> -	CO - Ottimizzazione scritture di integrazione (#TT03929/25) 
> -	FI - Nuove opzioni per la dichiarazione fiscale Ro 394. **Attenzione! Questa modifica può impattare sui profili** (#TT04183/25) 
...
> -	WM - Analisi Disponibilità: ottimizzazione delle prestazioni, corretta lettura della disponibilità e della quantità non disponibile, corretta lettura degli scarichi registrati e non, corretta lettura dei sovraconsumi di produzione. Corretta lettura difforme dei dati in base alle condizioni di filtro dell’articolo (#TT04181/25, #TT04123/25, #TT04175/25) 
> -	WM - Piani di carico - Migliorato inserimento ordine cliente in piano di carico (#TT03326/25, #TT02960/25) 
...
> -	FI - Dichiarazioni 300 e 394 per la Romania - codici IVA 11 e 21 (#TT04041/25) 
> -	FI - Liquidazione iva periodica, aggiunto collegamento alle anagrafiche per impostare la società che presenta la comunicazione per conto di un altro contribuente. **Attenzione! Questa modifica può impattare sui profili** (#TT04050/25) 
> -	FI - Proposta dipartimento PostingCostCenter quando non arriva sulla struttura (#TT04126/25) 
> -	FI/SD - Corretto problema di visibilità nel campo Conto Sottoconto Descrizione, Form Interessate: Tesoreria > Lock Manager > tab Blocco Clienti e Vendite > Ordine Cliente > Dettaglio righe > Tab Agenti. **Attenzione! Questa modifica può impattare sui profili** (#TT03290/25) 
...
> -	SCM - Richieste di Acquisto: Corretto errore nella visualizzazione dei risultati delle tiles (#TT04139/25) 
...
> -	WM - Anagrafica articolo, correzione della coerenza dei dati nel tab Approvvigionamento (#TT03614/25) 
...
> -	WM - Piani di carico - Risolta anomalia in inserimento ordine cliente in piano di carico (#TT02960/25) 
...
> - BI - Correzione della chiamata all’algoritmo da query basata su SWITCHBOARD (#TT03876/25) 
...
> - SD - Ordini Clienti: abilitata la possibilità di salvare un profilo impostando un filtro sulla data di creazione dell’ordine. **Attenzione! Questa modifica può impattare sui profili** (#TT03107/25) 
...
> - WM - Modificata la stampa della valorizzazione dell’inventario per la Romania (#TT03782/25) 
...
> - SD - Aggiunto BatchRegisterSetter per FSSalesOrderItemBatchMovement(#TT03486/25) 
...
> - SD - Stampa Fattura di Vendita: Risolta anteprima di stampa che esce vuota se non è già attivo il flag stampata (#TT03536/25, #TT03531/25) 
...
> - FI - Stampa registri iva: revisione del riporto dei totali in caso di stampa del registro IVA con il flag Riepilogativo attivo (#TT03414/25) 
...
> - SD - Correzione del problema di conversione da Offerta di Vendita a Ordine di Vendita già collegato (#TT02871/25) 
...
> - SD - Stampa liquidazioni provvigioni e Stampa provvigioni maturate: risolto problema che si verificava in caso di inserimento di un agente con ‘pagamento totale’ come tipo documento considerato nel calcolo provvigionale. **Attenzione! Questa modifica può impattare sui profili** (#TT03352/25) 
...
> - FI - Anagrafiche contatti: Risolto problema nella versione web relativo alla ricerca delle anagrafiche. **Attenzione! Questa modifica può impattare sui profili** (#TT03225/25) 
...
> - SH - Datasource - caricamento della proprietà di estensione se è presente una personalizzazione per l’oggetto business (#TT03250/25)  
> - SH - Introdotta la possibilità di salvare la riga filtro all'interno dei profili (#TT02942/25) 
> - WM - Aggiunta la colonna ubicazione nella griglia lotti e serial number del picking. Inoltre, corretto bug in gestione spunta nel caso in cui venisse spuntato un lotto, già presente nel tab lotti e serial number, ma con un'altra ubicazione. **Attenzione! Questa modifica può impattare sui profili** (#TT03288/25) 
...
> - CO - Fix problema CO SalesForecast ModelDocumentFilter (#TT03248/25) 
...
> - PR - Nella distinta di presentazione effetti, l’help effetti ora presenta i filtri di ricerca per Cig/Cup. **Attenzione! Questa modifica può impattare sui profili** (#TT03078/25) 
...
> - SD - Nella stampa “Provvigioni maturate” e nella procedura di “Creazione automatica liquidazione provvigioni” è stato aggiunto un nuovo flag di conteggio dei pagamenti in registrazioni provvisorie. **Attenzione! Questa modifica può impattare sui profili** (#TT03196/25) 
> - SD - Offerte di Vendita: Aggiunta una barra di scorrimento verticale nel tab Dati articolo per facilitare visualizzazione dei dati nelle offerte contenenti un numero elevato di righe articolo. **Attenzione! Questa modifica può impattare sui profili** (#TT03170/25) 
...
> - SD - spedizioni - gestiti destinatari/destinazioni impostati come default in anagrafica cliente. **Attenzione! Questa modifica può impattare sui profili** (#TT00524/25) 
...
> - Risolto il problema con il protocollo SSL sul connettore email BizLink. 
...
> - WM - Conferma Picking, risolto il problema che impediva la modifica del lotto e dell'ubicazione durante la conferma picking da WMS (#TT02950/25) 
...
> - SD - Impostato il progetto per tutte le righe articolo, inclusi i NoteItem (#TT02904/25)   
> - SD - Listini di Vendita: abilitata la possibilità di gestire delle customizzazioni nela procedura di duplica e manutenzione listini (#TT02914/25) 
...
> - SD - Righe groupage spedizioni - indirizzo del luogo di carico proposto dai dati società oppure dal sito produttivo se indicato; Indirizzo del luogo di destinazione proposto dall’anagrafica cliente. **Attenzione! Questa modifica può impattare sui profili** (#TT00514/25) 
...
> - SCM - Creazione Automatica Ordini: quando l'ordine viene creato da RDA la data di prevista consegna e la data consegna vengono riportate nei prototipi di creazione e poi anche nell'ordine fornitore (#TT02696/25) 
...
> - FI - Modificata la procedura ‘Liquidazione iva di gruppo’ per abilitare la creazione della liquidazione di gruppo anche quando non c’è un gruppo iva. > - WM - In gestione picking è stata variata la logica nel seguente modo: nel caso di inserimento di un lotto manualmente, in automatico dalla riga spunta, con importazione WebApi (se manca la data inserimento lotto nel file), la data inserimento per la riga lotto del picking sarà la data odierna. Mentre, la data inserimento per la riga lotto del picking sarà la data del picking nel caso della proposta automatica lotti, all’evasione da ordine cliente, alla creazione del picking per lista UDC e dal Piano carico. **Attenzione! Questa modifica può impattare sui profili** (#TT02321/25) 
...
> - FI - compensazione veloce, abilitata la compensazione anche su partite con pagamenti fornitori non contabilizzati (saranno conteggiate per la differenza nell’edit del residuo da pagare presente sopra la griglia) > - WM - In gestione picking è stata variata la logica nel seguente modo: nel caso di inserimento di un lotto manualmente, in automatico dalla riga spunta, con importazione WebApi (se manca la data inserimento lotto nel file), la data inserimento per la riga lotto del picking sarà la data odierna. Mentre, la data inserimento per la riga lotto del picking sarà la data del picking nel caso della proposta automatica lotti, all’evasione da ordine cliente, alla creazione del picking per lista UDC e dal Piano carico. **Attenzione! Questa modifica può impattare sui profili** (#TT02037/25) 
...
> - ARM - Abilitata una nuova regola di validazione sull’oggetto standard quando Arm è in modalità personalizzata.
...
> - FI - Scheda Rollback pagamento fornitore - mostra registrazioni automatiche nella scheda precedente (#TT02623/25) 
...
> - SD - Listini di Vendita - Duplica e Manutenzione Listini: apportate le modifiche necessarie per poter customizzare l'oggetto (#TT02782/25) 
...
> - SCM - Creazione compenso da documenti SDI in entrata: Revisionata la procedura di eliminazione del compenso generato da fatture di acquisto provenienti dal ciclo passivo SDI (#TT00648/25) 
...
> - SH - Ricarica il filtro dal widget dei risultati quando è selezionato il layout predefinito (#TT00474/24)  
> - ARM - Corretta la pubblicazione dei riferimenti dell’oggetto di estensione (#TT02289/25)  
...
> - SD - Correzione dell’esecuzione di SalesOrder/SalesDeliveryNote in modalità oggetto, risolvendo il problema di modifica della quantità (#TT02659/25) 
...
> - FI - Nelle stampe ‘Controllo sbilanci centri di costo/centri di ricavo/progetti’, ‘Brogliaccio’, ‘Riepilogo movimenti per causale’ è stato aggiunto il filtro per divisione impostato con la divisione attiva ma modificabile. **Attenzione! Questa modifica può impattare sui profili** (#TT02118/25) 
> - FI - Stampa Intrastat - Risolta anomalia nella stampa in caso di più società che utilizzando l’intrastat sulla stessa base dati. **Attenzione! Questa modifica può impattare sui profili** (#TT01937/25) 
...
> - PR - Risolta importazione DocFinance (#TT02102/25) 
...
> - F2023 - Commissioni agenti - ricalcolo. **Attenzione! Questa modifica può impattare sui profili** (#TT01871/25) 
...
> - FI - Registrazioni contabili: attivata la possibilità di modificare il centro aziendale di imputazione per fatture di acquisto estere anche in caso di autofattura contabilizzata e inviata. **Attenzione! Questa modifica può impattare sui profili** (#TT01112/25) 
...
> - SD - Ricerca offerte filtrando per anagrafica cliente con abilitato flag “Ricerca contatto anche come contatto padre” - estende la ricerca ai contatti crm che hanno come padre un contatto collegato con l’anagrafica ricercata. **Attenzione! Questa modifica può impattare sui profili** (#TT01265/25) 
> - CO - Scritture per cost driver, revisione assegnazione conti (#TT02108/25) 
> - FI - Nella procedura Scritture di assestamento, l’impostazione del flag ‘Spunta tutto’ per la sezione superiore restituisce ora un messaggio di spunta su tutte le righe dei Centri di costo. **Attenzione! Questa modifica può impattare sui profili** (#TT00890/25)  
...
> - FI - all’interno del cespite, la modifica manuale dell’ammortamento calcolato va ora ad aggiornare gli importi a centro di costo così come i campi di deducibilità/indeducibilità. **Attenzione! Questa modifica può impattare sui profili** (#TT01809/25)  
...
> - FI - Scritture di assestamento: revisione procedura di ripristino assestamento. **Attenzione! Questa modifica può impattare sui profili** (#TT01860/25) 
...
> - CO - chiusura infrannuale, nuovi campi per memorizzare la data creazione e l’utente arm di creazione. **Attenzione! Questa modifica può impattare sui profili** (#TT01918/25) 
...
> - SCM - Corretta la memorizzazione dei filtri impostati nella form Dettaglio righe ordini, che non venivano salvati correttamente nei profili. **Attenzione! Questa modifica può impattare sui profili** (#TT01063/25)
...
> - MES - Corretto il layout del report Foglio di lavoro presente nel filtro degli ordini di produzione (#TT01027/25)
> - SCM - Corretta la visualizzazione dei campi Classe articolo e Codice articolo nella procedura di Importazione da Prezzi fornitore (#TT00715/25) **Attenzione! Questa modifica può impattare sui profili**
...
> - FI - Unlimited digit number on currency adjustment procedure (#TT00991/25) Changes were made in exchange field of form CurrencyAdjustmentAccounting. **Attenzione! Questa modifica può impattare sui profili**
