...
> -	CO - Scritture di Rettifica: abilitata la possibilità di esportare i dati della griglia. Modifications in Scritture di Rettifica form can have an impact on profiles (#TT04136/25)
...
> - FI - Anagrafiche contatti: Risolto problema nella versione web relativo alla ricerca delle anagrafiche. Modifications in nomenclature filter can have an impact on profiles (#TT03225/25) 
