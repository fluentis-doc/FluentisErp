...
- **Raggruppa fasi esterne**: contestuale al tabulatore Fasi, il pulsante è abilitato solamente se si selezionano due o più fasi esterne contigue. L'esecuzione richiederà la nuova Fase standard che andrà a sostituire le fasi esterne selezionate ed il Terzista che effettuerà le lavorazioni. Il terzista che verrà proposto sarà quello indicato nella Fase standard selezionata; se non indicato verrà proposto quello presente nella prima Fase esterna selezionata, se non indicato verrà richiesto di essere inserito dall'operatore. Le Fasi esterne verranno raggruppate se e solo se non siano già stati creati i documenti di Consegna materiali e/o Rientri di conto lavoro. Un eventuale ordine di conto lavoro, precedentemente creato per una o più delle fasi esterne selezionate, verrà eliminato.   
- **Ripristina raggruppamento**: contestuale al tabulatore Fasi, il pulsante è abilitato solamente se si seleziona una fase esterna precedentemente raggruppata. Le fasi esterne raggruppate verranno ripristinate se e solo se, per la fase esterna raggruppata, non siano già stati creati i documenti di Consegna materiali e/o Rientri di conto lavoro.   
- **Crea ordine di conto lavoro**: contestuale al tabulatore Fasi, il pulsante è abilitato solamente se si seleziona una Fase esterna e, a quella Fase esterna, non sia già stato creato un Ordine di conto lavoro. Alla Fase esterna selezionata verrà generato un Ordine di conto lavoro.   
