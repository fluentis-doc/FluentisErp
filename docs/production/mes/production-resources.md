...
description: Configurazione e gestione delle risorse produttive nel modulo MES di Fluentis, incluse impostazioni generali, layout, controlli qualità e sospensioni.
keywords:
  - MES Fluentis
...
Attraverso questa finestra vengono gestiti tutti i parametri legati alle risorse di produzione utilizzate nel MES.
...
Questa pagina descrive la configurazione completa delle *Risorse di produzione* nel MES Fluentis, includendo:

- importazione delle risorse  
- parametri generali e multi‑fase  
- gestione documentale  
- controlli qualità  
- causali di sospensione  
...
- [Dipendente](/docs/project-management/registers/employee/new-employee/)  
- [Foglio di lavoro](/docs/production/pp-production-in-progress/reports/worksheet)